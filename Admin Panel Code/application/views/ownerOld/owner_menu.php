                            ...
                            <table id="tb" class="table datatables table-bordered">
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><a style="color: #3c8dbc;font-size:12px!important;" href="<?php echo base_url();?>dashboard/updateMenu/<?php echo $item->menu_id;?>">Edit</a> / <a style="color: green;font-size:12px!important; " href="<?php echo base_url();?>dashboard/editMenuImages/<?php echo $item->menu_id;?>">Images</a>
