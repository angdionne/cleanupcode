                            ...
                            <thead>
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><a style="color: #3c8dbc;font-size:12px!important;" href="<?php echo base_url();?>admin/updateKitchen/<?php echo $item->kitchen_id;?>">Edit</a> / <a style="color: red;font-size:12px!important;"onClick="return doconfirm();"  href="<?php echo base_url();?>index.php/admin/deleteKitchen/<?php echo $item->kitchen_id;?>">Delete</a> </td>
                                    </tr><?php }?>
                                </tbody>
                            </table>
                        </div>
