                            ...
                            <table id="tb" class="table datatables table-bordered">
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><a style="color: #3c8dbc;font-size:12px!important;" href="<?php echo base_url();?>dashboard/updateMenu/<?php echo $item->menu_id;?>">Edit</a> / <a style="color: red;font-size:12px!important;"onClick="return doconfirm();"  href="<?php echo base_url();?>index.php/dashboard/deleteMenu/<?php echo $item->menu_id;?>">Delete</a> </td>
                                    </tr>
                                <?php }?>
                                </tbody>
                            </table>
