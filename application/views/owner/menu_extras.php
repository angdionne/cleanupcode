                            ...
                            <div >
                                ...
                                {?>
                                    <tr>
                                        ...
                                        <td><a style="color: #3c8dbc;font-size:12px!important;" href="<?php echo base_url();?>dashboard/updateTopping/<?php echo $d->m_extra_id;?>">Edit</a> / <a style="color: red;font-size:12px!important;"onClick="return doconfirm();"  href="<?php echo base_url();?>index.php/dashboard/deleteTopping/<?php echo $d->m_extra_id;?>">Delete</a> </td>
                                    </tr>
                                <?php }?>
                                </tbody>
                            </table>
